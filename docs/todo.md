...
- [ ] solve vexing parse around how to resolve `a[b];` expr-stmts caused by my array syntax, peek in loop to see if we find a `token_is_posttype_indicator` or `;` first? See `tests/9.br`
- [ ] structs
- [ ] marks
- [ ] closures?
